...
[ "$YES_OR_NO" = "y" ] && {
    ...
    L6="Successfully, backup is in /root."
    ...
    L21="successfully"
    L22="Nodejs fast script is running."
    L23="Nodejs installation completed"
    L24="Start installing redis"
    L25="successfully"
    L26="Redis security settings completed"
    L27="successfully, Please check if there has error."
    L28="Read the system information successfully,start setting source."
    ...
    L36="Next, please install nodebb with yourself"
}
[ "$YES_OR_NO" = "n" ] && {
